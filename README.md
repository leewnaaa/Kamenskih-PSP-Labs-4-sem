...
3. [Создание слоя для работы с API](#создание-слоя-для-работы-с-API)
   - 4.1 [stockUrls.js](#stockurlsjs)
   - 4.2 [ajax.js](#ajaxjs)
4. [Реализация на главной странице](#реализация-на-главной-странице)
   - 5.1 [Загрузка списка](#загрузка-списка)
   - 5.2 [Создание нового счёта](#создание-нового-счёта)
5. [Реализация на странице деталей](#реализация-на-странице-деталей)
6. [Проблема CORS и её решение](#проблема-cors-и-её-решение)
5. [Выводы](#выводы)

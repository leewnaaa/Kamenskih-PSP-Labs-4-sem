...
1. [ЛР 1. Calculator. HTML/CSS](#лр-1-calculator-htmlcss)
2. [Стиль калькулятора](#стиль-калькулятора)
   - 2.1 [Стиль кнопок калькулятора](#стиль-кнопок-калькулятора)
   - 2.2 [Стиль окна с результатом](#стиль-окна-с-результатом)
3. [Стиль дополнительных элементов управления](#стиль-дополнительных-элементов-управления)
4. [Стиль информационных блоков](#стиль-информационных-блоков)
5. [Выполненное дополнительное задание](#выполненное-дополнительное-задание)

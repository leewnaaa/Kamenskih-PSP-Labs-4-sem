...
- [1. Создание слоя для работы с API](#1-создание-слоя-для-работы-с-api)
- [2. Реализация API на главной странице (список счетов)](#2-реализация-api-на-главной-странице-список-счетов)
- [3. Реализация API на странице деталей счёта](#3-реализация-api-на-странице-деталей-счёта)
- [4. Решение проблемы CORS](#4-решение-проблемы-cors)
- [5. Выводы](#5-выводы)

...
1. [Программирование кнопок калькулятора](#программирование-кнопок-калькулятора)
   - 1.1 [Программирование кнопок с цифрами](#программирование-кнопок-с-цифрами)
   - 1.2 [Программирование кнопок простых операций (+, -, *, /)](#программирование-кнопок-простых-операций----)
   - 1.3 [Программирование кнопки операции "="](#программирование-кнопки-операции-)
   - 1.4 [Программирование кнопки "С" (очистка)](#программирование-кнопки-с-очистка)
   - 1.5 [Программирование кнопки "+/-" (смена знака)](#программирование-кнопки---смена-знака)
   - 1.6 [Программирование кнопки "%" (проценты)](#программирование-кнопки--проценты)
   - 1.7 [Программирование кнопки "⌫" (удаление последнего символа)](#программирование-кнопки--удаление-последнего-символа)
   - 1.8 [Программирование кнопки "√" (квадратный корень)](#программирование-кнопки--квадратный-корень)
   - 1.9 [Программирование кнопки "x²" (возведение в квадрат)](#программирование-кнопки-x-возведение-в-квадрат)
   - 1.10 [Программирование кнопки "x!" (факториал)](#программирование-кнопки-x-факториал)
   - 1.11 [Программирование унарных операций с обработкой ошибок](#программирование-унарных-операций-с-обработкой-ошибок)
2. [Программирование окна с результатом](#программирование-окна-с-результатом)
3. [Программирование кнопки переключения темы](#программирование-кнопки-переключения-темы)
4. [Выполненное дополнительное задание](#выполненное-дополнительное-задание)
